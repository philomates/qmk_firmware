...
[_BL] = LAYOUT_ortho_1x1( KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC, \
         ...
         KC_LCTL, KC_LGUI, KC_LALT,                 KC_SPC,          KC_FN1, KC_FN0, KC_LEFT, KC_DOWN, KC_RIGHT ),
[_FL] = LAYOUT_ortho_1x1(
         ...
         KC_TRNS, KC_AUDIO_VOL_DOWN, KC_FN2, KC_TRNS, KC_TRNS, KC_TRNS, KC_END, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, RESET, \
         KC_TRNS, KC_TRNS, KC_TRNS,                 KC_TRNS,          KC_TRNS, KC_TRNS, KC_HOME, KC_PGDOWN, KC_END ),
};

// TODO figure out how to wire up the function keymaps
